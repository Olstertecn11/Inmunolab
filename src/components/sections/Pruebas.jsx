  ...
  return (
    <div>
      <CustomSlide images={images}
        ...
        texts={["A través de tecnologías de vanguardia y métodos de diagnóstico avanzados, realizamos una evaluación exhaustiva del sistema inmunológico de cada paciente, identificando de manera precisa posibles desequilibrios y disfunciones. Nuestros servicios incluyen pruebas especializadas de alergia, perfiles inmunológicos completos, evaluaciones de respuesta inmune a enfermedades específicas y terapias personalizadas diseñadas para mejorar la función inmunológica y promover la salud a largo plazo.",
